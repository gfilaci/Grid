...
//////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////
// disable conserved current utilities in the perturbative case
//////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////

template <>
void WilsonKernels<QCDpt::PWilsonSmellImplF>::SeqConservedCurrentSiteBwd(const SitePropagator &q_in,
                                                     SitePropagator &q_out,
                                                     DoubledGaugeField &U,
                                                     unsigned int sU,
                                                     unsigned int mu,
...
template <>
void WilsonKernels<QCDpt::PWilsonSmellImplD>::SeqConservedCurrentSiteBwd(const SitePropagator &q_in,
                                                     SitePropagator &q_out,
                                                     DoubledGaugeField &U,
                                                     unsigned int sU,
                                                     unsigned int mu,
...
template <>
void WilsonKernels<QCDpt::WilsonSmellImplF>::SeqConservedCurrentSiteBwd(const SitePropagator &q_in,
                                                     SitePropagator &q_out,
                                                     DoubledGaugeField &U,
                                                     unsigned int sU,
                                                     unsigned int mu,
...
template <>
void WilsonKernels<QCDpt::WilsonSmellImplD>::SeqConservedCurrentSiteBwd(const SitePropagator &q_in,
                                                     SitePropagator &q_out,
                                                     DoubledGaugeField &U,
                                                     unsigned int sU,
                                                     unsigned int mu,
...
template<>
void WilsonKernels<QCDpt::PWilsonSmellImplF>::SeqConservedCurrentSiteFwd(const SitePropagator &q_in,
                                                     SitePropagator &q_out,
                                                     DoubledGaugeField &U,
                                                     unsigned int sU,
                                                     unsigned int mu,
...
template<>
void WilsonKernels<QCDpt::PWilsonSmellImplD>::SeqConservedCurrentSiteFwd(const SitePropagator &q_in,
                                                     SitePropagator &q_out,
                                                     DoubledGaugeField &U,
                                                     unsigned int sU,
                                                     unsigned int mu,
...
template<>
void WilsonKernels<QCDpt::WilsonSmellImplF>::SeqConservedCurrentSiteFwd(const SitePropagator &q_in,
                                                     SitePropagator &q_out,
                                                     DoubledGaugeField &U,
                                                     unsigned int sU,
                                                     unsigned int mu,
...
template<>
void WilsonKernels<QCDpt::WilsonSmellImplD>::SeqConservedCurrentSiteFwd(const SitePropagator &q_in,
                                                     SitePropagator &q_out,
                                                     DoubledGaugeField &U,
                                                     unsigned int sU,
                                                     unsigned int mu,
...
template<>
void WilsonKernels<QCDpt::PWilsonSmellImplF>::ContractConservedCurrentSiteBwd(
                                                  const SitePropagator &q_in_1,
                                                  const SitePropagator &q_in_2,
                                                  SitePropagator &q_out,
                                                  DoubledGaugeField &U,
...
template<>
void WilsonKernels<QCDpt::PWilsonSmellImplD>::ContractConservedCurrentSiteBwd(
                                                  const SitePropagator &q_in_1,
                                                  const SitePropagator &q_in_2,
                                                  SitePropagator &q_out,
                                                  DoubledGaugeField &U,
...
template<>
void WilsonKernels<QCDpt::WilsonSmellImplF>::ContractConservedCurrentSiteBwd(
                                                  const SitePropagator &q_in_1,
                                                  const SitePropagator &q_in_2,
                                                  SitePropagator &q_out,
                                                  DoubledGaugeField &U,
...
template<>
void WilsonKernels<QCDpt::WilsonSmellImplD>::ContractConservedCurrentSiteBwd(
                                                  const SitePropagator &q_in_1,
                                                  const SitePropagator &q_in_2,
                                                  SitePropagator &q_out,
                                                  DoubledGaugeField &U,
...
template<>
void WilsonKernels<QCDpt::PWilsonSmellImplF>::ContractConservedCurrentSiteFwd(
                                                  const SitePropagator &q_in_1,
                                                  const SitePropagator &q_in_2,
                                                  SitePropagator &q_out,
                                                  DoubledGaugeField &U,
...
template<>
void WilsonKernels<QCDpt::PWilsonSmellImplD>::ContractConservedCurrentSiteFwd(
                                                  const SitePropagator &q_in_1,
                                                  const SitePropagator &q_in_2,
                                                  SitePropagator &q_out,
                                                  DoubledGaugeField &U,
...
template<>
void WilsonKernels<QCDpt::WilsonSmellImplF>::ContractConservedCurrentSiteFwd(
                                                  const SitePropagator &q_in_1,
                                                  const SitePropagator &q_in_2,
                                                  SitePropagator &q_out,
                                                  DoubledGaugeField &U,
...
template<>
void WilsonKernels<QCDpt::WilsonSmellImplD>::ContractConservedCurrentSiteFwd(
                                                  const SitePropagator &q_in_1,
                                                  const SitePropagator &q_in_2,
                                                  SitePropagator &q_out,
                                                  DoubledGaugeField &U,
