...
// SeqConservedCurrent is disabled in the perturbative case
template <>
void WilsonFermion<QCDpt::PWilsonSmellImplF>::SeqConservedCurrent(PropagatorField &q_in,
                                              PropagatorField &q_out,
                                              Current curr_type,
                                              unsigned int mu,
                                              std::vector<Real> mom,
...
template <>
void WilsonFermion<QCDpt::PWilsonSmellImplD>::SeqConservedCurrent(PropagatorField &q_in,
                                              PropagatorField &q_out,
                                              Current curr_type,
                                              unsigned int mu,
                                              std::vector<Real> mom,
...
template <>
void WilsonFermion<QCDpt::WilsonSmellImplF>::SeqConservedCurrent(PropagatorField &q_in,
                                              PropagatorField &q_out,
                                              Current curr_type,
                                              unsigned int mu,
                                              std::vector<Real> mom,
...
template <>
void WilsonFermion<QCDpt::WilsonSmellImplD>::SeqConservedCurrent(PropagatorField &q_in,
                                              PropagatorField &q_out,
                                              Current curr_type,
                                              unsigned int mu,
                                              std::vector<Real> mom,
