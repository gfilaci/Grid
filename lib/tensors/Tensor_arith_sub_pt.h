    ...
    Source file: ./lib/tensors/Tensor_arith_sub_pt.h
...
Author: Gianluca Filaci <g.filaci@ed.ac.uk>
    ...
    *************************************************************************************/
    /*  END LEGAL */
#ifndef GRID_MATH_ARITH_SUB_PT_H
#define GRID_MATH_ARITH_SUB_PT_H
...
// perturbative series +/- perturbative series

template<class vtype,class ltype,class rtype,int N> strong_inline void sub(iPert<vtype,N> * __restrict__ ret,
