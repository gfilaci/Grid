...
int main (int argc, char ** argv)
{
  ...
  typedef typename StaggeredFermion<QCDpt::NaiveStaggeredImplD>::FermionField FermionField;
  typedef typename StaggeredFermion<QCDpt::NaiveStaggeredImplD>::ComplexField ComplexField;
  typename StaggeredFermion<QCDpt::NaiveStaggeredImplD>::ImplParams params;
  ...
  */
  ...
  StaggeredFermion<QCDpt::NaiveStaggeredImplD> Ds(Umu,Grid,RBGrid,mass,params);
...
std::cout<<GridLogMessage<<"=========================================================="<<std::endl;
  ...
  { // Simple staggered implementation
    ...
    Lattice<iScalar<vInteger> > lin_t(&Grid); lin_t=x+y+z;
      ...
      tmp = PeriodicBC::CovShiftForward(U[muu],muu,src);
      ref = ref +0.5*tmp*phases;
  ...
  SchurDiagMooeeOperator<StaggeredFermion<QCDpt::NaiveStaggeredImplD>,FermionField> HermOpEO(Ds);
