...
Source file: ./lib/qcd/action/fermion/NaiveStaggeredKernels.h
...
*************************************************************************************/
/*  END LEGAL */
#ifndef GRID_QCD_NAIVE_STAGGERED_KERNELS_H
#define GRID_QCD_NAIVE_STAGGERED_KERNELS_H
...
namespace QCD {
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class NaiveStaggeredKernelsStatic { 
 public:
...
template<class Impl> class NaiveStaggeredKernels : public FermionOperator<Impl> , public NaiveStaggeredKernelsStatic { 
 public:
...
public:
   ...
   void DhopDir(StencilImpl &st, DoubledGaugeField &U, SiteSpinor * buf,
		      int sF, int sU, const FermionField &in, FermionField &out, int dir);
   ...
   void DhopSite(StencilImpl &st, LebesgueOrder &lo, DoubledGaugeField &U, SiteSpinor * buf,
		int sF, int sU, const FermionField &in, FermionField &out);

   void DhopSiteDag(StencilImpl &st, LebesgueOrder &lo, DoubledGaugeField &U, SiteSpinor *buf,
                   int LLs, int sU, const FermionField &in, FermionField &out);
  
public:

  NaiveStaggeredKernels(const ImplParams &p = ImplParams());
